...
void Water::Init()
{
	...
	m_frameBufferA = new FrameBuffer(m_resWidth,m_resHeight, EFBT_TEXTURE_RGBA8|EFBT_TEXTURE_DEPTH);
	m_frameBufferB = new FrameBuffer(m_resWidth,m_resHeight, EFBT_TEXTURE_RGBA8|EFBT_TEXTURE_DEPTH); 
}
